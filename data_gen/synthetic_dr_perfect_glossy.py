...
def save_opt(args, params, crop_size):
    write_bitmap('%s/optimized_textures/perfect_geometry/diffuse_opt.exr' % args.data_dir, params['obj_1.bsdf.bsdf_0.reflectance.data'], (512, 512), write_async=False)
    write_bitmap('%s/optimized_textures/perfect_geometry/alpha_opt.exr' % args.data_dir, params['obj_1.bsdf.weight.data'], (512, 512), write_async=False)
...
if __name__ == '__main__':
    ...
    imageio.imwrite('%s/optimized_textures/perfect_geometry/alpha_opt.exr' % args.data_dir, init_tex)
    ...
    for epoch in range(0, 2):
        ...
        for i, img_name in enumerate(img_list):
            ...
            params.keep(['obj_1.bsdf.bsdf_0.reflectance.data', 'obj_1.bsdf.weight.data'])
            params.update()
