...
# if [ ! -f "$COLMAP_PATH/$VOCAB_BIN" ]; then
# 	echo "Create Vocab"
# 	touch $COLMAP_PATH/$VOCAB_BIN
# 	colmap vocab_tree_builder \
# 				--database_path $COLMAP_PATH/$DATABASE_PATH \
# 				--vocab_tree_path $COLMAP_PATH/$VOCAB_BIN
# fi
...
# 			--database_path $COLMAP_PATH/$DATABASE_PATH \
# 			--VocabTreeMatching.vocab_tree_path $COLMAP_PATH/$VOCAB_BIN \
# 			--VocabTreeMatching.match_list_path $DATASET_PATH/$IMAGE_LIST
# echo "Vocab done"
